...
public class DeviceControl2Activity extends Activity implements View.OnClickListener {
    private final static String TAG = DeviceControl2Activity.class.getSimpleName();
...
//                invalidateOptionsMenu();
                ...
                Toast.makeText(DeviceControl2Activity.this,"连接成功可以主动获取数据了",Toast.LENGTH_LONG).show();
...
//    }
    ...
    public void onSwitchBulbClicked(View v) {
        if (mConnected == false) {
            Toast.makeText(DeviceControl2Activity.this, "请先连接设备", Toast.LENGTH_SHORT).show();
        } else {
